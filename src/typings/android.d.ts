					...
					export module chatbox {
						export class ChatboxController {
							...
							public constructor(implementation: {
								getListeners(): java.util.List<com.iadvize.conversation.sdk.controller.chatbox.ChatboxListener>;
								setListeners(param0: java.util.List<com.iadvize.conversation.sdk.controller.chatbox.ChatboxListener>): void;
					...
					export module notification {
						export class NotificationController {
							...
							public constructor(implementation: {
								...
								enablePushNotifications(param0: com.iadvize.conversation.sdk.model.SDKCallback): void;
								disablePushNotifications(param0: com.iadvize.conversation.sdk.model.SDKCallback): void;
					...
					export module targeting {
						export class TargetingController {
							...
							public constructor(implementation: {
								...
								registerUserNavigation(param0: com.iadvize.conversation.sdk.model.targeting.NavigationOption): void;
								activateTargetingRule(param0: java.util.UUID): void;
								getLanguage(): com.iadvize.conversation.sdk.model.language.LanguageOption;
								setLanguage(param0: com.iadvize.conversation.sdk.model.language.LanguageOption): void;
							});
							public constructor();
				...
				export module controller {
					export module visitor {
						export class VisitorController {
							 ...
							 */
							public constructor(implementation: {
								registerCustomData(param0: java.util.List<com.iadvize.conversation.sdk.model.visitor.CustomData>, param1: com.iadvize.conversation.sdk.model.SDKCallback): void;
							});
							public constructor();
			...
			export module views {
				...
				export module GenericCardView {
					export class a {
						 ...
						 */
						public constructor(implementation: {
							b(param0: globalAndroid.view.View, param1: com.iadvize.conversation_ui.models.MessageAttachment.Action): void;
						});
						public constructor();
						public b(param0: globalAndroid.view.View, param1: com.iadvize.conversation_ui.models.MessageAttachment.Action): void;
					}
			...
			export module views {
				...
				export module ProductOfferView {
					export class a {
						 ...
						 */
						public constructor(implementation: {
							a(param0: globalAndroid.view.View, param1: com.iadvize.conversation_ui.models.MessageAttachment.Action): void;
						});
						public constructor();
						public a(param0: globalAndroid.view.View, param1: com.iadvize.conversation_ui.models.MessageAttachment.Action): void;
					}
